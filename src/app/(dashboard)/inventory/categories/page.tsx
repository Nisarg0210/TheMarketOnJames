                                ...
                                <table className="w-full text-sm text-left">
                                    <thead className="bg-gray-50 text-gray-700 uppercase">
                                        <tr>
                                            ...
                                            <th className="px-4 md:px-6 py-3">Products</th>
                                    ...
                                    <tbody>
                                        {categories.map((category) => (
                                            <tr key={category.id} className="border-b hover:bg-gray-50">
                                                <td className="px-4 md:px-6 py-4 font-medium">{category.name}</td>
                                                <td className="px-4 md:px-6 py-4">{category._count.products}</td>
                                        ...
                                        {categories.length === 0 && (
                                            <tr>
                                                <td colSpan={3} className="px-4 md:px-6 py-4 text-center text-muted-foreground">
                                                    No categories found.
                                                </td>
                                            </tr>
                                        )}
